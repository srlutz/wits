...
if(time_step=="R") weight_input=1 # if the user has chosen to use raw data without any kind of pre-treatment, the weighting factor for the input of the summer months will be set to one and no correction will be applied.
