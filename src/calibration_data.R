...
if(calib_subset=="N") {outputseries1 <- outputseries1[which(outputdates1>calib_dates[1] & outputdates1<calib_dates[2])]; outputdates1 <- outputdates1[which(outputdates1>calib_dates[1] & outputdates1<calib_dates[2])]} # if the option to crop the output time series and only use a part of if for calibration has been chosen, the calibration vector is adapted accordingly. 
