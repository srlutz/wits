...
if(tracer=="ST" | tracer=="H3+ST") {dummy2=as.numeric(format(as.Date(date_decimal(stable_input_date)),"%m"))} # extracts the months from the data vector of input
if(tracer=="H3") {dummy2=as.numeric(format(as.Date(date_decimal(h3_input_date)),"%m"))} # extracts the months from the data vector of input
